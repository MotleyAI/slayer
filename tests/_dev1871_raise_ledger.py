...
ROWS: Tuple[LedgerRow, ...] = (
    ...
    _row(_EE, "check_collapsing_transform_not_row_mixed", "ValueError",
         "A collapsing transform (first/last) aggregated together with a row-level column is not yet supported: the collapsed value is a re-aggregation, which cannot be broadcast onto a row-level operand. Aggregate the column, or use the transform in a pure aggregation of attached values.",
         "checker", "transform-constituent", True, "checker"),
