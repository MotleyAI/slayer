...
ROWS: Tuple[LedgerRow, ...] = (
    ...
    _row(_EE, "check_reaggregation_dims_attributable", "ValueError",
         ...
         "checker", "reaggregation", True, "checker"),
    _row(_EE, "check_reaggregation_not_standalone_and_mixed", "ValueError",
         "Re-aggregation '…' is used both on its own and inside a mixed row-level aggregation in the same query; this shape is not yet supported. Select the two in separate queries.",
         "checker", "reaggregation", True, "checker"),
