...
ROWS: Tuple[LedgerRow, ...] = (
    ...
    _row(_EE, "check_attached_param_requires_attached_source", "SlayerError",
         "Aggregation … parameter … is a partitioned aggregate, but the aggregation's source is a row-level value; the parameter would need the attached value on the aggregation's own input rows. Aggregate the source to the parameter's grain, or use a row-level parameter.",
         "checker", "parameter", True, "checker"),
