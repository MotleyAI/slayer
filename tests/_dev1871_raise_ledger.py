...
ROWS: Tuple[LedgerRow, ...] = (
    ...
    _row(_SP, "_reject_unsupported_windowed_key", "ValueError",
    ...
    _row(_SP, "_reject_unsupported_windowed_key", "ValueError",
         ...
         "checker", "local-partitioned", True, "checker"),
    _row(_SP, "_guard_windowed_measures", "ValueError",
         ...
         "checker", "time-axis", True, "checker", sites=2),
    _row(_SP, "_guard_partitioned_measures", "NotImplementedError",
    ...
    _row(_SP, "_guard_partitioned_measures", "NotImplementedError",
         ...
         "checker", "local-partitioned", True, "checker", deferral=True),
    _row(_SP, "_windowed_slot_id_set", "RuntimeError",
         "Windowed measure … was selected but has no projection slot; planner/projection drift (DEV-1714).",
         "internal", "internal", False, "compiler"),
    _row(_SP, "_reject_measure_refs_in_filters", "DistinctDimensionValuesError",
         "distinct_dimension_values=False rejects measure references, but filter … contains one. …",
         "checker", "positions", True, "checker"),
    _row(_SP, "_reject_measure_refs_in_order", "DistinctDimensionValuesError",
    ...
    _row(_SP, "_reject_measure_refs_in_order", "DistinctDimensionValuesError",
         ...
         "checker", "positions", True, "checker"),
    _row(_SP, "bind_query_inputs", "ValueError",
    ...
    _row(_SP, "bind_query_inputs", "ValueError",
         ...
         "checker", "time-axis", True, "checker"),
    _row(_SP, "_validate_partition_keys", "ValueError",
    ...
    _row(_SP, "_validate_partition_keys", "ValueError",
         ...
         "checker", "local-partitioned", True, "checker"),
    _row(_SP, "_find_regroup_slot", "ValueError",
         "Regroup producer plan is missing the … slot for …; synthesis and planning disagree on its grain.",
         "internal", "internal", False, "compiler"),
    _row(_SP, "_regroup_answer_slot_id", "ValueError",
         "Regroup producer plan is missing the answer slot for …; synthesis and planning disagree on its grain.",
         "internal", "internal", False, "compiler"),
    _row(_SP, "_assert_attach_covers_producer_grain", "ValueError",
         ...
         "internal", "internal", False, "compiler"),
    _row(_SP, "_assert_partition_key_attributable", "ValueError",
         ...
         "checker", "local-partitioned", True, "checker"),
    _row(_SP, "_assert_cross_model_inputs_safe", "ValueError",
    ...
    _row(_SP, "_assert_cross_model_inputs_safe", "ValueError",
         ...
         "checker", "cross-model", True, "checker"),
    _row(_SP, "_assert_local_producer_inputs_safe", "ValueError",
    ...
    _row(_SP, "_assert_local_producer_inputs_safe", "ValueError",
         ...
         "checker", "local-partitioned", True, "checker"),
    _row(_SP, "_trailing_window_kernel", "RuntimeError",
         "Windowed producer is missing its window duration or bucket slot; synthesis and planning disagree (DEV-1838).",
         "internal", "internal", False, "compiler"),
    ...
    _row(_SP, "_conjunct_push_plan", "_PushBlocked",
         ...
         "control", "positions", False, "compiler"),
    _row(_SP, "_synthesize_cross_model_producer", "ValueError",
    ...
    _row(_SP, "_synthesize_cross_model_producer", "ValueError",
         ...
         "checker", "cross-model", True, "checker"),
    _row(_SP, "_synthesize_association_producer", "SlayerError",
    ...
    _row(_SP, "_synthesize_association_producer", "SlayerError",
         ...
         "checker", "association", True, "checker"),
    _row(_SP, "_synthesize_reaggregation_producer", "SlayerError",
    ...
    _row(_SP, "_synthesize_reaggregation_producer", "SlayerError",
         ...
         "checker", "reaggregation", True, "checker"),
    _row(_SP, "_synthesize_reaggregation_producer", "ValueError",
    ...
    _row(_SP, "_assert_total_routing", "ValueError",
         ...
         "internal", "internal", False, "compiler"),
    _row(_SP, "_plan_regroups", "ValueError",
    ...
    _row(_SP, "plan_query", "DistinctDimensionValuesError",
         ...
         "checker", "positions", True, "checker"),
    _row(_SP, "plan_query", "RuntimeError",
         "Cross-model aggregate slot … survived the regroup desugar (DEV-1838 D8); every cross-model aggregate must become a target-rooted producer.",
         "internal", "internal", False, "compiler"),
    _row(_SP, "plan_query", "PositionTypingError",
         ...
         "checker", "positions", True, "checker"),
    _row(_SP, "_reject_opaque_grouping_dim", "ValueError",
    ...
    _row(_SP, "_guard_flatten", "ValueError", "",
         "checker", "names", True, "checker"),
    _row(_SP, "_declared_measures_from_query", "ValueError",
    ...
    _row(_SP, "_topo_sort", "ValueError",
         ...
         "compiler", "stages", True, "compiler"),
    _row(_SP, "_emit_stage_schema", "ValueError", "",
         "checker", "names", True, "checker"),
    _row(_SP, "_validate_model_filter", "ValueError",
    ...
    _row(_SP, "_validate_model_filter", "ValueError",
         ...
         "checker", "model-filters", True, "checker"),
    _row(_SP, "_build_date_range_filter", "ValueError",
         "date_range filter for TimeDimension … expected a column reference; got ….",
         "internal", "internal", False, "compiler"),
    _row(_SP, "_resolve_main_time_dimension", "AmbiguousReferenceError", "",
         "bind", "time-axis", True, "bind"),
    _row(_SP, "_resolve_main_time_dimension", "UnknownReferenceError", "",
         "bind", "time-axis", True, "bind"),
    _row(_RP, "type_position_conjunct", "PositionTypingError",
    ...
    _row(_RP, "type_position_conjunct", "PositionTypingError",
         ...
         "checker", "positions", True, "checker"),
    _row(_PL, "_validate_alias_collisions", "MeasureNameCollidesWithColumnError", "",
         "checker", "names", True, "checker"),
    _row(_PL, "_validate_alias_collisions", "CanonicalAliasShadowsColumnError", "",
         "checker", "names", True, "checker"),
    _row(_PL, "intern", "DuplicateMeasureNameError", "",
         "checker", "names", True, "checker"),
    _row(_PL, "_merge_into_existing", "DuplicateMeasureNameError", "",
         "checker", "names", True, "checker"),
    _row(_PL, "desugar_change", "ValueError",
         "desugar_change expected op='change', got ….",
         "internal", "internal", False, "compiler"),
    _row(_PL, "desugar_change_pct", "ValueError",
         "desugar_change_pct expected op='change_pct', got ….",
         "internal", "internal", False, "compiler"),
