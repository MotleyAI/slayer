...
ROWS: Tuple[LedgerRow, ...] = (
    ...
    _row(_EE, "check_partition_key_resolves", "ValueError",
         ...
         "checker", "local-partitioned", True, "checker"),
    _row(_EE, "check_transform_partition_keys_in_operand_grain", "ValueError",
         "Transform '…': partition_by column '…' is not a member of the transform's operand grain (…); a rank-family transform partitions its operand's cells. Add it to the inner aggregate's partition_by=, or partition by one of: ….",
         "checker", "local-partitioned", True, "checker"),
