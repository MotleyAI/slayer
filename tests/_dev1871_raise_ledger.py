...
ROWS: Tuple[LedgerRow, ...] = (
    ...
    _row(_EE, "check_windowed_time_dimension", "ValueError",
         ...
         "checker", "time-axis", True, "checker"),
    _row(_EE, "check_time_shift_input", "ValueError",
    ...
    _row(_EE, "check_time_shift_input", "ValueError",
         "'time_shift' does not support a row-level (non-aggregate) leaf inside a composite input; every leaf must be an aggregate. Compute the row-level value in an earlier stage of a multi-stage `source_queries` model and reference its aggregate here.",
         "checker", "positions", True, "checker"),
