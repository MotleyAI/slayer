...
**Nesting** — Formulas can be nested: `cumsum(change(revenue))` applies `cumsum` to the result of `change`. Each level of nesting generates an additional CTE layer in the SQL.
