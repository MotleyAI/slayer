...
A key requirement for an expressive semantic layer is [joins](../joins/joins.md). Once you have a join defined, it's easy to reuse dimensions from child models — you've already joined the underlying table, just refer to dimension definitions prefixed with the right subquery alias.
