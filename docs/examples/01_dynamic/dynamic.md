...
The answer is that **queries can also be used as models,** and combined with [dynamic joins](../05_joins/joins.md#dynamic-joins-modelextension) enable a **concise, natural, and powerful representation of general [multistage queries](../06_multistage_queries/multistage_queries.md)**.