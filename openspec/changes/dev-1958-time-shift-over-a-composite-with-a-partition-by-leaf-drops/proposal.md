...
- A ranked leaf inside a shifted composite (`time_shift(amount:last / 2, -1)`) executes instead of raising an internal error; a windowed leaf inside a shifted composite is evaluated with its window instead of silently dropping it.
