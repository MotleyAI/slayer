...
column along stored join edges, traversed in either orientation. What a model
determines has exactly one value per model row and behaves as the model's own field;
