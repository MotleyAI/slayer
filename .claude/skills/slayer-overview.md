...
Discovery: `models_summary`, `inspect_model` (with sample data)
Querying: `query`
Model editing: `create_model`, `update_model`, `add_measures`, `add_dimensions`, `delete_measures_dimensions`, `delete_model`
Datasources: `create_datasource`, `list_datasources`, `describe_datasource`, `list_tables`, `delete_datasource`
