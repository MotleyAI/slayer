...
Search: `search` (two-channel: entity-overlap BM25 over memories + tantivy full-text over memories ∪ entities; partitions query-bearing memories into `example_queries` — see [search.md](../../docs/concepts/search.md))
